      ...
      <Container>
        ...
        <div className="grid gap-6">
          ...
          <section className="bg-gray-800 rounded-2xl shadow-2xl p-6 md:p-8 border border-gray-700">
            <h1 className="text-3xl font-bold text-white mb-2">🧭 Geografía y Regiones</h1>
            <p className="text-gray-300">Diversidad geográfica y regiones principales de China</p>
          </section>

          {/* Regions */}
          <section className="bg-gray-800 rounded-2xl shadow-2xl p-6 md:p-8 border border-gray-700">
            <h2 className="text-2xl font-bold text-white mb-4">Regiones Principales</h2>
          ...
          {/* Landmarks */}
          <section className="bg-gray-800 rounded-2xl shadow-2xl p-6 md:p-8 border border-gray-700">
            <h2 className="text-2xl font-bold text-white mb-4">Puntos de Interés</h2>
