    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 p-4">
      <Container>
        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-6 md:p-8 border border-gray-700">
          <h1 className="text-3xl font-bold text-white mb-2">🎎 Tradiciones y Festividades</h1>
          <p className="text-gray-300 mb-6">Calendario festivo y etiqueta básica.</p>
          ...
          {data?.traditions?.etiquette && (
            <div>
              <h2 className="text-xl font-semibold text-white mb-4">Etiqueta Básica</h2>
