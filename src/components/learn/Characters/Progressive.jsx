      ...
      <div className="max-w-4xl mx-auto pt-8 pb-8">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-2">Lecciones Progresivas</h2>
            <p className="text-gray-300">Repasa 6 caracteres por lección</p>
          </div>
              ...
              <div key={idx} className="bg-gradient-to-br from-gray-700 to-gray-600 rounded-xl p-6 hover:shadow-lg transition border border-gray-600">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-300 font-semibold">Pinyin:</span>
                    <span className="text-xl text-white">{char.pinyin}</span>
                  </div>
                  {char.radical && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-300 font-semibold">Radical:</span>
