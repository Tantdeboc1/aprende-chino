      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center mb-2">
            <h1 className="text-2xl font-bold text-[var(--ink)]">{t('radicals_identify_radicals_title')}</h1>
            <div className="text-[var(--mute)]">
        ...
        {/* Pregunta */}
        <div className="bg-[var(--paper-hi)] rounded-2xl p-4 sm:p-8 border border-[var(--hair)] mb-6 text-center">
          <h3 className="text-lg text-[var(--mute)] mb-4">{t('radicals_question_header')}</h3>

          {/* Carácter objetivo */}
          <div className="text-6xl sm:text-8xl font-bold text-[var(--ink)] mb-4 sm:mb-8 py-2 sm:py-4">
            {currentQ.targetChar}
          </div>

          <h4 className="text-lg text-[var(--mute)] mb-4 sm:mb-6">{t('radicals_select_correct_radical')}</h4>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            {currentQ.options.map((option, index) => {
              ...
              let buttonClass = "bg-[var(--paper-hi2)] hover:bg-[var(--mute2)] border-[var(--hair-s)]";
              ...
              if (isAnswered) {
                if (isCorrect) {
                  ...
                  buttonClass = "bg-[var(--paper-hi2)] border-[var(--hair-s)] opacity-50";
                }
              }
              ...
              return (
                <button
                  ...
                  disabled={isAnswered}
                  className={`${buttonClass} border-2 rounded-2xl p-6 text-4xl font-bold text-[var(--ink)] transition disabled:cursor-not-allowed`}
                >
                  {option}
                </button>
              );
