      ...
      <div className="min-h-screen bg-[#f4ecdc] p-4">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#1c1813] text-center">{t('minigames_pinyin_connection_title')}</h1>
            <p className="text-[#928a76] text-center">{t('minigames_pinyin_connection_subtitle')}</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#f4ecdc] p-4">
      <Container>
        ...
        {currentQuestion && (
          <div className="text-center">
            <div className="bg-[#fbf5e6] border-2 border-[rgba(28,24,19,0.10)] rounded-2xl w-full max-w-md mx-auto h-48 flex items-center justify-center mb-8">
              <span className="text-8xl font-bold text-[#1c1813]">{currentQuestion.character}</span>
            </div>
              ...
              {currentQuestion.options.map((option, i) => {
                ...
                if (feedback) {
                  if (option === currentQuestion.correctPinyin) {
                    buttonClass = "bg-[#2f6b4a] animate-pulse";
                  } else if (option === selectedAnswer) {
                    buttonClass = "bg-[#c8392f]";
                  }
                }
