      ...
      <div className="min-h-screen bg-gray-900 p-4">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-white text-center">{t('minigames_pinyin_connection_title')}</h1>
            <p className="text-gray-400 text-center">{t('minigames_pinyin_connection_subtitle')}</p>
          </div>
