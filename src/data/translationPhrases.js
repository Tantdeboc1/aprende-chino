...
export const translationPhrases = [
  ...
  },
  {
    ...
    translations: {
      ...
      fr: "Combien de personnes y a-t-il dans votre famille ?",
      de: "Wie viele Personen gibt es in eurer Familie?",
      it: "Quante persone ci sono nella vostra famiglia?",
      pt: "Quantas pessoas há na vossa família?",
    },
    hanzi: "你们家有几口人？",
  ...
  },
  {
    ...
    translations: {
      ...
      en: "In the evening she also has English class.",
      fr: "Le soir, elle a aussi cours d'anglais.",
      de: "Abends hat sie auch Englischunterricht.",
      it: "La sera lei ha anche lezione di inglese.",
      pt: "À noite ela também tem aula de inglês.",
    },
    hanzi: "晚上她还有英语课。",
  ...
  },
  {
    ...
    translations: {
      ...
      en: "It is five minutes to seven.",
  ...
  },
  {
    ...
    translations: {
      ...
      en: "In total, how many people are there in your class?",
      fr: "Au total, combien de personnes y a-t-il dans ta classe ?",
